    ...
    return (
        <div className="bg-[#010851] md:px-14 p-4 max-w-screen-2xl mx-auto text-white">
            <div className='my-12 flex flex-col md:flex-row gap-10'>
                <div className='md:w-1/2 space-y-8'> 
                    <a href="/" className='text-2xl font-semibold flex items-center space-x-3 text-primary'>
                        <img src={logo} alt="" className='w-10 inline-block items-center'/><span className='text-white'>LEARN</span>
                    </a>
                ...
                <div className='md:w-1/2 flex flex-col md:flex-row flex-wrap justify-between gap-8 items-start'>
                    ...
                    <div className='space-y-4 mt-5'>
                        ...
                        <ul className='space-y-3'>
                            ...
                            <p className='hover:text-gray-300'>Ad ratione reprehenderit consequatur</p>
                            <p className='hover:text-gray-300'>678905</p>
            ...
            <div className='flex flex-col sm:flex-row gap-8 sm:items-center justify-between my-8'>
                <p>@ LEARN 2021 --- 2025. All rights reserved</p>

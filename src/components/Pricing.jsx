...
const Pricing = () => {
    ...
    const packages = [
        {name: "Start", monthlyPrice: 19, yearlyPrice: 199, description: "Lorem ipsum dolor sit amet, consectetur oluptatem molestias ducimus praesentium impedit! "},
        {name: "Advance", monthlyPrice: 39, yearlyPrice: 399, description: "Lorem ipsum dolor sit amet, consectetur oluptatem molestias ducimus praesentium impedit! "},
        {name: "Premium", monthlyPrice: 59, yearlyPrice: 599, description: "Lorem ipsum dolor sit amet, consectetur oluptatem molestias ducimus praesentium impedit! "},

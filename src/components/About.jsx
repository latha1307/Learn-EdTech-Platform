        ...
        <div className="md:px-14 p-4 max-w-s mx-auto space-y-10" id='about'>
            <div className='flex flex-col md:flex-row justify-between items-center gap-8'>
                ...
                className='md:w-2/5'>
                    ...
                    <p className='text-tartiary text-lg mb-7'>A good example of a paragraph contains a topic conclusion. There many different kinds of animals that live in China.</p>
